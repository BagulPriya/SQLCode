...
INSERT INTO Employees_n (id, name, salary, department_id, manager_id, hire_date)
VALUES 
...
(select 
    * ,
	row_number()over(partition by id,name order by salary) as rn
from Employees_n
)
Delete from Deleted_cte
where rn > 1